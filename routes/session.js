...
router.put('/sessions/:id', passport.authenticate('jwt', { session: false }), sessionControllers.updateSession);
...
router.delete('/sessions/:id/', passport.authenticate('jwt', { session: false }), sessionControllers.deleteSession);
